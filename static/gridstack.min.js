...
<html lang="en" class=" is-u2f-enabled">
  <head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# object: http://ogp.me/ns/object# article: http://ogp.me/ns/article# profile: http://ogp.me/ns/profile#">
    ...
    <title>gridstack.js/gridstack.min.js at master · troolee/gridstack.js</title>
    ...
    <meta property="fb:app_id" content="1401488693436528">
      ...
      <meta content="https://avatars0.githubusercontent.com/u/137888?v=3&amp;s=400" name="twitter:image:src" /><meta content="@github" name="twitter:site" /><meta content="summary" name="twitter:card" /><meta content="troolee/gridstack.js" name="twitter:title" /><meta content="gridstack.js is a jQuery plugin for widget layout" name="twitter:description" />
      <meta content="https://avatars0.githubusercontent.com/u/137888?v=3&amp;s=400" property="og:image" /><meta content="GitHub" property="og:site_name" /><meta content="object" property="og:type" /><meta content="troolee/gridstack.js" property="og:title" /><meta content="https://github.com/troolee/gridstack.js" property="og:url" /><meta content="gridstack.js is a jQuery plugin for widget layout" property="og:description" />
      <meta name="browser-stats-url" content="https://api.github.com/_private/browser/stats">
    <meta name="browser-errors-url" content="https://api.github.com/_private/browser/errors">
    <link rel="assets" href="https://assets-cdn.github.com/">
    <link rel="web-socket" href="wss://live.github.com/_sockets/VjI6OTk2NjU5NTg6N2FjZjIwOGJiZDE2YTNhMzAwYzRjNDBkOWEyZDM0YTJkYzRlMWNiZDJhYzM4ZGY1YWVjNjE2MmNhZmUxYzZmNg==--938819865874144398210cbfa89f0a96c1394303">
    <meta name="pjax-timeout" content="1000">
    <link rel="sudo-modal" href="/sessions/sudo_modal">
    <meta name="request-id" content="8CF4:7559:1059C4F:1A875DD:5882D45B" data-pjax-transient>
...
<meta content="collector.githubapp.com" name="octolytics-host" /><meta content="github" name="octolytics-app-id" /><meta content="8CF4:7559:1059C4F:1A875DD:5882D45B" name="octolytics-dimension-request_id" /><meta content="154617" name="octolytics-actor-id" /><meta content="joram" name="octolytics-actor-login" /><meta content="7e2071ea842569867db585b150ce202022ae6295288452fe234936c2f3ff61a1" name="octolytics-actor-hash" />
<meta content="/&lt;user-name&gt;/&lt;repo-name&gt;/blob/show" data-pjax-transient="true" name="analytics-location" />
  ...
  <meta class="js-ga-set" name="dimension1" content="Logged In">
    ...
    <meta name="user-login" content="joram">

        <meta name="expected-hostname" content="github.com">
      <meta name="js-proxy-site-detection-payload" content="">


      <link rel="mask-icon" href="https://assets-cdn.github.com/pinned-octocat.svg" color="#000000">
      <link rel="icon" type="image/x-icon" href="https://assets-cdn.github.com/favicon.ico">

    <meta name="html-safe-nonce" content="08e01652364dc901907f4d85f6a479434f8f8000">
  ...
  <link href="https://github.com/troolee/gridstack.js/commits/master.atom" rel="alternate" title="Recent Commits to gridstack.js:master" type="application/atom+xml">
      ...
      <link rel="canonical" href="https://github.com/troolee/gridstack.js/blob/master/dist/gridstack.min.js" data-pjax-transient>
  </head>
  ...
  <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/troolee/gridstack.js/search" class="js-site-search-form" data-scoped-search-url="/troolee/gridstack.js/search" data-unscoped-search-url="/search" method="get"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /></div>
...
<ul class="header-nav user-nav float-right" id="user-links">
  <li class="header-nav-item">
    ...
    <a href="/notifications" aria-label="You have unread notifications" class="header-nav-link notification-indicator tooltipped tooltipped-s js-socket-channel js-notification-indicator" data-channel="tenant:1:notification-changed:154617" data-ga-click="Header, go to notifications, icon:unread" data-hotkey="g n">
...
<a class="dropdown-item" href="https://gist.github.com/" data-ga-click="Header, create new gist">
  ...
  <div class="dropdown-header">
    <span title="troolee/gridstack.js">This repository</span>
  </div>
    <a class="dropdown-item" href="/troolee/gridstack.js/issues/new" data-ga-click="Header, create new issue">
      New issue
    </a>
  ...
  <li class="header-nav-item dropdown js-menu-container">
    <a class="header-nav-link name tooltipped tooltipped-sw js-menu-target" href="/joram"
       aria-label="View profile and more"
       data-ga-click="Header, show menu, icon:avatar">
      <img alt="@joram" class="avatar" height="20" src="https://avatars2.githubusercontent.com/u/154617?v=3&amp;s=40" width="20" />
      <span class="dropdown-caret"></span>
    </a>
    ...
    <div class="dropdown-menu-content js-menu-content">
      <div class="dropdown-menu dropdown-menu-sw">
        <div class="dropdown-header header-nav-current-user css-truncate">
          Signed in as <strong class="css-truncate-target">joram</strong>
        </div>

        <div class="dropdown-divider"></div>

        <a class="dropdown-item" href="/joram" data-ga-click="Header, go to profile, text:your profile">
          Your profile
        </a>
        <a class="dropdown-item" href="/joram?tab=stars" data-ga-click="Header, go to starred repos, text:your stars">
          Your stars
        </a>
        ...
        <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/logout" class="logout-form" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="U/qP/sbFkUWBHamAHEfUh1mjh1MgHTcZhQv2rt9KqjbEd1for9BH1OKGH30C1fDPH8MXl1TYIWmOoQYrznjjfw==" /></div>
...
<ul class="pagehead-actions">
  ...
  <li>
        <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/notifications/subscribe" class="js-social-container" data-autosubmit="true" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="CLafAC8Rdmwiz649BQcbErwpevC7kzBGtDhDENNHDdMuO7mE595/zINTQkTfDSb/CzlM82ArW7x3TsaSz9X4Ww==" /></div>      <input class="form-control" id="repository_id" name="repository_id" type="hidden" value="26417283" />

        <div class="select-menu js-menu-container js-select-menu">
          <a href="/troolee/gridstack.js/subscription"
          ...
          <a class="social-count js-social-count"
            href="/troolee/gridstack.js/watchers"
  ...
  <li>
    ...
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/troolee/gridstack.js/unstar" class="starred" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="w+lReSDmOyLHeiP9EFIXOeAcDyTcY473g1OipTp2mg/EtYrR7sPcEnh0ZaCUgTJ8QKU+UauyDqdt7lN7ODU01Q==" /></div>
      <button
        type="submit"
        class="btn btn-sm btn-with-count js-toggler-target"
        aria-label="Unstar this repository" title="Unstar troolee/gridstack.js"
    ...
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/troolee/gridstack.js/star" class="unstarred" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="3j1oyps7zIEMAapS2JuMGQj6ZOWcsyKatecy3rVybdNc+5yaUe7E9KHr3ETh+0acv2sW6q5kb/qtH+EJ+/AfGg==" /></div>
      <button
        type="submit"
        class="btn btn-sm btn-with-count js-toggler-target"
        aria-label="Star this repository" title="Star troolee/gridstack.js"
  ...
  <li>
          <a href="#fork-destination-box" class="btn btn-sm btn-with-count"
              title="Fork your own copy of troolee/gridstack.js to your account"
              aria-label="Fork your own copy of troolee/gridstack.js to your account"
              rel="facebox"
          ...
          <div id="fork-destination-box" style="display: none;">
            ...
            <include-fragment src=""
                ...
                data-url="/troolee/gridstack.js/fork?fragment=1">
  ...
  <span class="author" itemprop="author"><a href="/troolee" class="url fn" rel="author">troolee</a></span><!--
--><span class="path-divider">/</span><!--
--><strong itemprop="name"><a href="/troolee/gridstack.js" data-pjax="#js-repo-pjax-container">gridstack.js</a></strong>
...
<nav class="reponav js-repo-nav js-sidenav-container-pjax"
  ...
  <span itemscope itemtype="http://schema.org/ListItem" itemprop="itemListElement">
    <a href="/troolee/gridstack.js" class="js-selected-navigation-item selected reponav-item" data-hotkey="g c" data-selected-links="repo_source repo_downloads repo_commits repo_releases repo_tags repo_branches /troolee/gridstack.js" itemprop="url">
    ...
    <span itemscope itemtype="http://schema.org/ListItem" itemprop="itemListElement">
      <a href="/troolee/gridstack.js/issues" class="js-selected-navigation-item reponav-item" data-hotkey="g i" data-selected-links="repo_issues repo_labels repo_milestones /troolee/gridstack.js/issues" itemprop="url">
  ...
  <span itemscope itemtype="http://schema.org/ListItem" itemprop="itemListElement">
    <a href="/troolee/gridstack.js/pulls" class="js-selected-navigation-item reponav-item" data-hotkey="g p" data-selected-links="repo_pulls /troolee/gridstack.js/pulls" itemprop="url">
  ...
  <a href="/troolee/gridstack.js/projects" class="js-selected-navigation-item reponav-item" data-selected-links="repo_projects new_repo_project repo_project /troolee/gridstack.js/projects">
    <svg aria-hidden="true" class="octicon octicon-project" height="16" version="1.1" viewBox="0 0 15 16" width="15"><path fill-rule="evenodd" d="M10 12h3V2h-3v10zm-4-2h3V2H6v8zm-4 4h3V2H2v12zm-1 1h13V1H1v14zM14 0H1a1 1 0 0 0-1 1v14a1 1 0 0 0 1 1h13a1 1 0 0 0 1-1V1a1 1 0 0 0-1-1z"/></svg>
    Projects
    <span class="counter">0</span>
</a>
    <a href="/troolee/gridstack.js/wiki" class="js-selected-navigation-item reponav-item" data-hotkey="g w" data-selected-links="repo_wiki /troolee/gridstack.js/wiki">
...
<a href="/troolee/gridstack.js/blob/c1c4ff8e92249e45942dba1057423201f1925ae0/dist/gridstack.min.js" class="d-none js-permalink-shortcut" data-hotkey="y">Permalink</a>

<!-- blob contrib key: blob_contributors:v21:13ca005c429c221bb89e9f83532246e3 -->
...
<div class="select-menu branch-select-menu js-menu-container js-select-menu float-left">
    ...
    <div class="select-menu-modal">
      ...
      <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket" data-tab-filter="branches" role="menu">
        ...
        <div data-filterable-for="context-commitish-filter-field" data-filterable-type="substring">
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
               href="/troolee/gridstack.js/blob/gh-pages/dist/gridstack.min.js"
               data-name="gh-pages"
               data-skip-pjax="true"
               rel="nofollow">
              <svg aria-hidden="true" class="octicon octicon-check select-menu-item-icon" height="16" version="1.1" viewBox="0 0 12 16" width="12"><path fill-rule="evenodd" d="M12 5l-8 8-4-4 1.5-1.5L4 10l6.5-6.5z"/></svg>
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open selected"
               href="/troolee/gridstack.js/blob/master/dist/gridstack.min.js"
               data-name="master"
               data-skip-pjax="true"
               rel="nofollow">
              <svg aria-hidden="true" class="octicon octicon-check select-menu-item-icon" height="16" version="1.1" viewBox="0 0 12 16" width="12"><path fill-rule="evenodd" d="M12 5l-8 8-4-4 1.5-1.5L4 10l6.5-6.5z"/></svg>
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
               href="/troolee/gridstack.js/blob/releases/dist/gridstack.min.js"
               data-name="releases"
               data-skip-pjax="true"
               rel="nofollow">
              <svg aria-hidden="true" class="octicon octicon-check select-menu-item-icon" height="16" version="1.1" viewBox="0 0 12 16" width="12"><path fill-rule="evenodd" d="M12 5l-8 8-4-4 1.5-1.5L4 10l6.5-6.5z"/></svg>
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
               href="/troolee/gridstack.js/blob/revert-532-patch-1/dist/gridstack.min.js"
               data-name="revert-532-patch-1"
               data-skip-pjax="true"
               rel="nofollow">
              <svg aria-hidden="true" class="octicon octicon-check select-menu-item-icon" height="16" version="1.1" viewBox="0 0 12 16" width="12"><path fill-rule="evenodd" d="M12 5l-8 8-4-4 1.5-1.5L4 10l6.5-6.5z"/></svg>
              <span class="select-menu-item-text css-truncate-target js-select-menu-filter-text">
      ...
      <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket" data-tab-filter="tags">
        <div data-filterable-for="context-commitish-filter-field" data-filterable-type="substring">
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
              href="/troolee/gridstack.js/tree/v0.2.6/dist/gridstack.min.js"
              data-name="v0.2.6"
              data-skip-pjax="true"
              rel="nofollow">
              <svg aria-hidden="true" class="octicon octicon-check select-menu-item-icon" height="16" version="1.1" viewBox="0 0 12 16" width="12"><path fill-rule="evenodd" d="M12 5l-8 8-4-4 1.5-1.5L4 10l6.5-6.5z"/></svg>
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
              href="/troolee/gridstack.js/tree/v0.2.5/dist/gridstack.min.js"
              data-name="v0.2.5"
              data-skip-pjax="true"
              rel="nofollow">
              <svg aria-hidden="true" class="octicon octicon-check select-menu-item-icon" height="16" version="1.1" viewBox="0 0 12 16" width="12"><path fill-rule="evenodd" d="M12 5l-8 8-4-4 1.5-1.5L4 10l6.5-6.5z"/></svg>
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
              href="/troolee/gridstack.js/tree/v0.2.4/dist/gridstack.min.js"
              data-name="v0.2.4"
              data-skip-pjax="true"
              rel="nofollow">
              <svg aria-hidden="true" class="octicon octicon-check select-menu-item-icon" height="16" version="1.1" viewBox="0 0 12 16" width="12"><path fill-rule="evenodd" d="M12 5l-8 8-4-4 1.5-1.5L4 10l6.5-6.5z"/></svg>
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
              href="/troolee/gridstack.js/tree/v0.2.3/dist/gridstack.min.js"
              data-name="v0.2.3"
              data-skip-pjax="true"
              rel="nofollow">
              <svg aria-hidden="true" class="octicon octicon-check select-menu-item-icon" height="16" version="1.1" viewBox="0 0 12 16" width="12"><path fill-rule="evenodd" d="M12 5l-8 8-4-4 1.5-1.5L4 10l6.5-6.5z"/></svg>
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
              href="/troolee/gridstack.js/tree/v0.2.2/dist/gridstack.min.js"
              data-name="v0.2.2"
              data-skip-pjax="true"
              rel="nofollow">
              <svg aria-hidden="true" class="octicon octicon-check select-menu-item-icon" height="16" version="1.1" viewBox="0 0 12 16" width="12"><path fill-rule="evenodd" d="M12 5l-8 8-4-4 1.5-1.5L4 10l6.5-6.5z"/></svg>
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
              href="/troolee/gridstack.js/tree/v0.2.1/dist/gridstack.min.js"
              data-name="v0.2.1"
              data-skip-pjax="true"
              rel="nofollow">
              <svg aria-hidden="true" class="octicon octicon-check select-menu-item-icon" height="16" version="1.1" viewBox="0 0 12 16" width="12"><path fill-rule="evenodd" d="M12 5l-8 8-4-4 1.5-1.5L4 10l6.5-6.5z"/></svg>
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
              href="/troolee/gridstack.js/tree/v0.2.0/dist/gridstack.min.js"
              data-name="v0.2.0"
              data-skip-pjax="true"
              rel="nofollow">
              <svg aria-hidden="true" class="octicon octicon-check select-menu-item-icon" height="16" version="1.1" viewBox="0 0 12 16" width="12"><path fill-rule="evenodd" d="M12 5l-8 8-4-4 1.5-1.5L4 10l6.5-6.5z"/></svg>
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
              href="/troolee/gridstack.js/tree/v0.1.0/dist/gridstack.min.js"
              data-name="v0.1.0"
              data-skip-pjax="true"
              rel="nofollow">
              <svg aria-hidden="true" class="octicon octicon-check select-menu-item-icon" height="16" version="1.1" viewBox="0 0 12 16" width="12"><path fill-rule="evenodd" d="M12 5l-8 8-4-4 1.5-1.5L4 10l6.5-6.5z"/></svg>
  ...
  <div class="breadcrumb js-zeroclipboard-target">
    <span class="repo-root js-repo-root"><span class="js-path-segment"><a href="/troolee/gridstack.js"><span>gridstack.js</span></a></span></span><span class="separator">/</span><span class="js-path-segment"><a href="/troolee/gridstack.js/tree/master/dist"><span>dist</span></a></span><span class="separator">/</span><strong class="final-path">gridstack.min.js</strong>
  </div>
</div>

<include-fragment class="commit-tease" src="/troolee/gridstack.js/contributors/master/dist/gridstack.min.js">
  <div>
...
<div class="file">
  ...
  <div class="file-actions">
    ...
    <div class="BtnGroup">
      <a href="/troolee/gridstack.js/raw/master/dist/gridstack.min.js" class="btn btn-sm BtnGroup-item" id="raw-url">Raw</a>
        <a href="/troolee/gridstack.js/blame/master/dist/gridstack.min.js" class="btn btn-sm js-update-url-with-hash BtnGroup-item" data-hotkey="b">Blame</a>
      <a href="/troolee/gridstack.js/commits/master/dist/gridstack.min.js" class="btn btn-sm BtnGroup-item" rel="nofollow">History</a>
    </div>


        <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/troolee/gridstack.js/edit/master/dist/gridstack.min.js" class="inline-form js-update-url-with-hash" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="9nUBIG7EMuvLCj27hExYv6qTzFmu8qAIZs/efygC6FpH7ySvl3avqPKoVSfXqstzgHFvAlj4BCbIKtWW6cdXHQ==" /></div>
          <button class="btn-octicon tooltipped tooltipped-nw" type="submit"
            aria-label="Fork this project and edit the file" data-hotkey="e" data-disable-with>
            <svg aria-hidden="true" class="octicon octicon-pencil" height="16" version="1.1" viewBox="0 0 14 16" width="14"><path fill-rule="evenodd" d="M0 12v3h3l8-8-3-3-8 8zm3 2H1v-2h1v1h1v1zm10.3-9.3L12 6 9 3l1.3-1.3a.996.996 0 0 1 1.41 0l1.59 1.59c.39.39.39 1.02 0 1.41z"/></svg>
          </button>
</form>        <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/troolee/gridstack.js/delete/master/dist/gridstack.min.js" class="inline-form" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="YtkBtdUHSONRm8gSM05rWVeBd/MUVDBvLIIgKvSHqQ8WbplqaypTU395VK57EGBj3xxQAOgKayXiSPISvLZZLA==" /></div>
  ...
  <div itemprop="text" class="blob-wrapper data type-javascript">
      ...
      <tr>
        ...
        <td id="LC2" class="blob-code blob-code-inner js-file-line"><span class="pl-c"> * gridstack.js 0.3.0-dev</span></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC4" class="blob-code blob-code-inner js-file-line"><span class="pl-c"> * (c) 2014-2016 Pavel Reznikov, Dylan Weiss</span></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC8" class="blob-code blob-code-inner js-file-line"><span class="pl-k">!</span><span class="pl-k">function</span>(<span class="pl-smi">a</span>){<span class="pl-k">if</span>(<span class="pl-s"><span class="pl-pds">&quot;</span>function<span class="pl-pds">&quot;</span></span><span class="pl-k">==</span><span class="pl-k">typeof</span> define<span class="pl-k">&amp;&amp;</span><span class="pl-smi">define</span>.<span class="pl-smi">amd</span>)<span class="pl-en">define</span>([<span class="pl-s"><span class="pl-pds">&quot;</span>jquery<span class="pl-pds">&quot;</span></span>,<span class="pl-s"><span class="pl-pds">&quot;</span>lodash<span class="pl-pds">&quot;</span></span>],a);<span class="pl-k">else</span> <span class="pl-k">if</span>(<span class="pl-s"><span class="pl-pds">&quot;</span>undefined<span class="pl-pds">&quot;</span></span><span class="pl-k">!=</span><span class="pl-k">typeof</span> <span class="pl-c1">exports</span>){<span class="pl-k">try</span>{jQuery<span class="pl-k">=</span><span class="pl-c1">require</span>(<span class="pl-s"><span class="pl-pds">&quot;</span>jquery<span class="pl-pds">&quot;</span></span>)}<span class="pl-k">catch</span>(a){}<span class="pl-k">try</span>{_<span class="pl-k">=</span><span class="pl-c1">require</span>(<span class="pl-s"><span class="pl-pds">&quot;</span>lodash<span class="pl-pds">&quot;</span></span>)}<span class="pl-k">catch</span>(a){}<span class="pl-en">a</span>(jQuery,_)}<span class="pl-k">else</span> <span class="pl-en">a</span>(jQuery,_)}(<span class="pl-k">function</span>(<span class="pl-smi">a</span>,<span class="pl-smi">b</span>){</td>
      </tr>
      <tr>
        <td id="L9" class="blob-num js-line-number" data-line-number="9"></td>
        <td id="LC9" class="blob-code blob-code-inner js-file-line"><span class="pl-c"><span class="pl-c">//</span> jscs:enable requireCamelCaseOrUpperCaseIdentifiers</span></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC11" class="blob-code blob-code-inner js-file-line"><span class="pl-c">    * <span class="pl-k">@class</span> GridStackDragDropPlugin</span></td>
      </tr>
      <tr>
        <td id="L12" class="blob-num js-line-number" data-line-number="12"></td>
        <td id="LC12" class="blob-code blob-code-inner js-file-line"><span class="pl-c">    * Base class for drag&#39;n&#39;drop plugin.</span></td>
      </tr>
      <tr>
...
<div id="jump-to-line" style="display:none">
  ...
  <div class="site-footer" role="contentinfo">
    ...
    <ul class="site-footer-links">
      <li>&copy; 2017 <span title="0.09953s from github-fe-0b0ad8d.cp1-iad.github.net">GitHub</span>, Inc.</li>
